...
describe('ChangeProfilePicture', () => {
  ...
  it('should call DeleteFile when file exists and SaveUserPicture throws', () => {
  ...
  it('should not call DeleteFile when file does not exists and SaveUserPicture throws', () => {
    userProfileRepo.savePicture.mockRejectedValueOnce(new Error())
    expect.assertions(1)
